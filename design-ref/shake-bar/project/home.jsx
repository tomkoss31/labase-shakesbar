    ...
    <div style={{ padding: '4px 16px 16px' }}>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative' }}>
          <div>
            <div style={{ fontSize: 13, color: palette.textDim, fontWeight: 500 }}>Salut Léa 👋</div>
            <div style={{ fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: 22, color: palette.text, lineHeight: 1.1, marginTop: 4 }}>
